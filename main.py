...
# dane przykład 12.2025
if __name__ == "__main__":
    data = {
        "country": ["A","A","A","A","A","A","B","B","C","C"],
        "year": [2000,2001,2002, 2003, 2004, 2005, 2000,2001,2000,2001],
        "press_free": [7.2, 6.8, 6.4, 6.0, 5.9, 6.5, 3.0, 2.5, 8.5, 8.8],
        "electoral_integrity": [6.0, 6.2, 5.0, 5.2, 6.0, 6.2, 2.1, 2.0, 7.2, 7.1],
        "judicial_independence": [5.5, 5.0, 5.5, 5.0, 6.5, 5.5, 1.0, 1.1, 6.0, 6.2],
        "civil_liberties": [6.8, 6.5, 5.5, 5.0, 6.5, 6.0, 2.3, 2.0, 8.0, 8.1],
        "gov_stability": [6.5, 6.7, 6.3, 6.4, 6.5, 6.1, 3.0, 2.9, 7.8, 7.9],
        "absence_of_violence": [9.0, 8.9, 8.5, 7.2, 8.0, 8.1, 5.0, 4.8, 9.5, 9.6]
    }
